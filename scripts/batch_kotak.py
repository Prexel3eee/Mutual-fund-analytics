"""Batch process Kotak Mahindra MF portfolio Excel files."""
import argparse
import json
import logging
import os
...
from src.kotak_etl import run_etl
...
log = logging.getLogger("batch_kotak")


def main():
    parser = argparse.ArgumentParser(
        description="Batch process Kotak Mahindra MF portfolio files"
    )
    parser.add_argument("input_dir", help="Directory containing Excel files")
    parser.add_argument("--output-dir", "-o", default="data/processed/kotak", 
    ...
    for idx, excel_file in enumerate(excel_files, 1):
        ...
        try:
            ...
            output_file = output_path / f"kotak_equity_holdings_{date_suffix}.json"
